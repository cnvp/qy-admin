    ...
    children: [
      {
        ...
        name: 'Module',
        meta: { title: '模型管理', noCache: true, icon: 'form', roles: ['admin'] }
      },
      {
        path: 'create',
        component: () => import('@/views/module/create'),
        name: 'CreateModule',
        meta: { title: '创建模型', noCache: true, icon: 'edit', roles: ['admin'] },
        hidden: true
      },
      {
        path: 'field/:moduleid',
        component: () => import('@/views/module/fieldindex'),
        meta: { title: '模型字段', noCache: true, roles: ['admin'] },
        hidden: true,
        children: [{
          path: '',
          component: () => import('@/views/module/field'),
          name: 'IndexField',
          meta: { title: '字段列表', noCache: true, roles: ['admin'] },
          hidden: true
        }, {
          path: 'create',
          component: () => import('@/views/module/createfield'),
          name: 'CreateField',
          meta: { title: '添加字段', noCache: true, roles: ['admin'] },
          hidden: true
        }, {
          path: ':fieldid',
          component: () => import('@/views/module/editfield'),
          name: 'EditField',
          meta: { title: '编辑字段', noCache: true, roles: ['admin'] },
          hidden: true
        }]
      },
      {
